...
public record StaffInvitation(
    ...
    public StaffInvitation accept(
            Instant currentTime,
            UserId acceptedUserId
            ){
        Objects.requireNonNull(currentTime, "Current time cannot be null");
        Objects.requireNonNull(acceptedUserId, "Accepted user id cannot be null");
    ...
    public static StaffInvitation create(
        ...
        Objects.requireNonNull(currentTime, "Current time cannot be null");
        Objects.requireNonNull(expiryTime, "Expires time cannot be null");
        Objects.requireNonNull(role, "Invitation role cannot be null");
    ...
    private static void validateAcceptanceMetadata(
        ...
        if (invitationStatus == StaffInvitationStatus.ACCEPTED && (!hasAcceptedAt || !hasAcceptedUserId)) {
