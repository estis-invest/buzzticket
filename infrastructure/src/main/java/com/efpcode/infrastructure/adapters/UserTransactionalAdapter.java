...
public class UserTransactionalAdapter implements StaffRegistrationCommands {
  ...
  private final CancelStaffInvitationUseCase cancelStaffInvitationUseCase;
  ...
  public UserTransactionalAdapter(
    ...
    this.cancelStaffInvitationUseCase = cancelStaffInvitationUseCase;
  ...
  @Override
  @Transactional
  public void cancelInvitation(StaffInvitationId id) {
    cancelStaffInvitationUseCase.execute(id, requestContext);
  }
}
